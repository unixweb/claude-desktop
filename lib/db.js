...
async function ensureSchema() {
  ...
  schemaReady = (async () => {
    ...
    `;
    await sql`CREATE INDEX IF NOT EXISTS idx_totp_codes_user ON totp_backup_codes(user_id);`;
    await sql`
    ...
    `;
    await sql`CREATE INDEX IF NOT EXISTS idx_reg_attempts_ip ON registration_attempts(ip);`;
    await sql`CREATE INDEX IF NOT EXISTS idx_reg_attempts_time ON registration_attempts(attempted_at);`;
    await sql`
