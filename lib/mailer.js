...
async function sendWelcomeMail(to, appUrl) {
  await sendMail({
    to,
    subject: 'Willkommen – Registrierung erfolgreich',
    textContent:
      `Hallo,\n\n` +
      `dein Konto wurde erfolgreich erstellt.\n` +
      `Du kannst dich jetzt anmelden: ${appUrl}/login\n\n` +
      `Viele Grüße`,
    htmlContent:
      `<p>Hallo,</p>` +
      `<p>dein Konto wurde erfolgreich erstellt.</p>` +
      `<p><a href="${appUrl}/login">Jetzt anmelden</a></p>` +
      `<p>Viele Grüße</p>`,
  });
}

module.exports = { sendPasswordResetMail, sendWelcomeMail };
